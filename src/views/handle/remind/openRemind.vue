<template>
  <div class="openCaller">
    <!-- 导航栏 -->
    <topHead><h3 slot="header">漏电提醒</h3></topHead>
    <!-- 内容 -->
    <div class="main">
      <div class="title"><h3>漏电提醒</h3></div>
      <p>
        漏电提醒详情介绍漏电提醒详情介绍漏电提醒详情介绍漏电提醒详情介绍漏电提醒详情介绍漏电提醒详情介绍漏电提醒详情介绍漏电提醒详情介
      </p>
      <p>
        漏电提醒详情介绍漏电提醒详情介绍漏电提醒详情介绍漏电提醒详情介绍漏电提醒详情介绍漏电提醒详情介绍漏电提醒详情介绍漏电提醒详情介
      </p>
      ...
      <van-button round type="info" @click="show = true">立即开通</van-button>

      <Popup :show="show" @showClick="closeClick(show)"> 
        <div class="conter" slot="conter">
          <p class="up">您即将开通漏电提醒业务</p> 
          <p class="low">每月资费￥5</p> 
        </div>
        <div class="bottom" slot="bottom">业务资费将在您的当前可用余额中扣除</div>
...
export default {
  ...
  methods: {
    ...
    goPay(){
      this.$router.push({ path: "openSuccess" })
    }
  }
};
</script>
